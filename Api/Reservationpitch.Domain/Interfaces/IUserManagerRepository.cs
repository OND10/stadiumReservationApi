...
namespace Reservationpitch.Domain.Interfaces
{
    public interface IUserManagerRepository
    {
        ...
        public Task<bool> SendToAllUsers(string message);
        public Task<IEnumerable<string>> GetUserMessages(string userId);
        public Task MarkMessagesAsRead(string userId);
        public Task<int> GetMessagesCount(string userId);
        public Task AddClaimsToUser(SystemUser user);
        Task<IList<Claim>> GetUserAssignedClaimsAsync(string userId);
