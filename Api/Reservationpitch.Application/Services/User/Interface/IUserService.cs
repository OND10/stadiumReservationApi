...
namespace Reservationpitch.Application.Services.User.Interface
{
    public interface IUserService
    {
        ...
        Task<Result<bool>>SendToAllUsersAsync(string message);
        Task<Result<int>>GetUserMessagesCount(string userId);
        Task<Result<IEnumerable<string>>> GetUserMessagesAsync(string userId);
